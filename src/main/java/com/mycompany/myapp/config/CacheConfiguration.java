...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Announcement.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Announcement.class.getName() + ".images", jcacheConfiguration);
